  ...
  Widget build(BuildContext context) {
    return ListView(padding: const EdgeInsets.only(bottom: 100), children: [
      ...
      CategorySection(
        ...
        children: [
          DestinationCard(
            imageUrl: 'https://source.unsplash.com/random/300x200/?chiangmai',
            title: 'Chiang Mai, Thailand',
            location: 'Northern Thailand',
            rating: 4.6,
            tags: ['Affordable', 'Culture', 'Food'],
          ),
          DestinationCard(
            imageUrl: 'https://source.unsplash.com/random/300x200/?lisbon',
            title: 'Lisbon, Portugal',
            location: 'Coastal Capital',
            rating: 4.7,
            tags: ['Value', 'History', 'Cuisine'],
          ),
          DestinationCard(
            imageUrl: 'https://source.unsplash.com/random/300x200/?mexicocity',
            title: 'Mexico City, Mexico',
            location: 'Historic Metropolis',
            rating: 4.5,
            tags: ['Affordable', 'Culture', 'Food'],
          ),
        ],
